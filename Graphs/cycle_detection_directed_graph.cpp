///Make the current node as visited and also mark the index in recursion stack.
//Find all the vertices which are not visited and are adjacent to the current node.
//If the adjacent vertices are already markedd in the recursion stack then a cycle is found.
